	...
	models.RSAKey.findOne({
		...
		models.User.findOne({
			...
			models.App.findOne({
				...
				send_git_response(msg, "App Name: "+app.name);
				send_git_response(msg, "App URL: https://nodegear.io/app/"+app.nameUrl);
				...
				models.AppProcess.find({
					...
					for (var i = 0; i < processes.length; i++) {
						// Restart the process
						send_git_response(msg, "Restarting Process ["+i+"/"+processes.length+"]: "+processes[i].name);
